...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-0">
	...
	<div class="d-flex justify-content-end">
		<ul class="navbar-nav">
			<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button"	data-bs-toggle="dropdown" aria-expanded="false"> Itinerario </a>
				<!-- aca le cambie el nombre de la class... -->
				<ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="navbarDarkDropdownMenuLink" >
					<table class="table">
						<thead>
							<tr>
							<!-- aca le cambie el color a las letras -->
								<th style="color: dark">Atracci&oacute;n</th>
								<th style="color: dark">Costo</th>
								<th style="color: dark">Duraci&oacute;n</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${listaAtracciones}" var="Atraccion">
								<tr>
									<td style="color: dark"><c:out value="${Atraccion.nombre}"></c:out></td>
									<td style="color: dark"><c:out value="${Atraccion.costo}"></c:out></td>
									<td style="color: dark"><c:out value="${Atraccion.tiempo}"></c:out></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
